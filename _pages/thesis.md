...
<main class="thesis-page">
  ...
  <section id="graduation-cap-3dgs" class="thesis-section glass-card">
    ...
    <p class="thesis-gaussian-note thesis-gaussian-note--lead">
      <span data-lang-only="en">This is a 3D Gaussian Splatting reconstruction of my Ph.D. graduation cap. The viewer loads directly on this page.</span>
      <span data-lang-only="zh">这是我的博士帽 3D Gaussian Splatting 重建，viewer 会直接在本页面加载。</span>
    </p>
    <p class="thesis-gaussian-note">
      <span data-lang-only="en">Many thanks to my lab partners and the cap makers: Wanfang Xu, Fuqi Xie, Shuqi He, Jifan Yang, and Shuzi Zou, and to my advisor Lingyun Yu.</span>
      <span data-lang-only="zh">特别感谢实验室伙伴和博士帽制作者：徐万芳、谢馥琪、何舒淇、杨济帆、邹树滋，以及导师俞凌云。</span>
    </p>
